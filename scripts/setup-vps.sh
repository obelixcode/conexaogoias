...
echo "🔧 SETUP VPS - CONEXÃO GOIÁS"
echo "============================="

echo "1. Conectando na VPS e configurando..."
...
mkdir -p /root/conexaogoias
cd /root/conexaogoias

echo "🔄 Clonando repositório..."
git clone https://github.com/rafaelsalles/conexaogoias.git . || {
