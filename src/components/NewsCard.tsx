...
export function NewsCard({ 
  ...
  if (variant === 'compact') {
    return (
      <a href={news.slug ? `/noticia/${news.slug}` : '#'} className={`${baseClasses} ${className}`}>
  ...
  return (
    <a href={news.slug ? `/noticia/${news.slug}` : '#'} className={`${baseClasses} ${variantClasses[variant]} ${className}`}>
